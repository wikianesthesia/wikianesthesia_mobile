# First Steps
* Obtain 12-lead ECG or print rhythm strip. Consider defibrillator pads
* Consider arterial line placement, ABG, and electrolytes
* Rule out sinus tachycardia:
    * Light Anesthesia
    * Hypovolemia
    * Hyperthermia
    * Early hypoxia/hypercapnea
    * Auto-PEEP

# Pulse Check
* **If no pulse or EtCO2 < 15 mm Hg: start CPR and go to** [ACLS-Asystole/PEA](Basic_PEA)

# Unstable
* Unstable if hypotensive, altered mental status, or chest pain
* Consider anesthetizing patient if awake
* Cardiovert immediately:
    * AFib/Aflutter: Synchronized 200 J Biphasic
    * Narrow Complex Tachycardia: Synchronized 100-200 J Biphasic
    * Monomorphic VT: Synchronized 100-200 J Biphasic
    * Polymorphic VT: **Un**synchronized High Energy Biphasic
* If refractory, increase energy and shock again
...
* If borderline pressures, **Amiodarone** (avoid if WPW) 150 mg IV over 10 mins
